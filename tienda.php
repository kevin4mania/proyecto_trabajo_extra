    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <?php
                    $registros = mysqli_query($conexion, "SELECT * FROM `Producto` JOIN `Fotos` ON Fotos.id_producto = Producto.id_producto WHERE Fotos.id_categoria = 1 LIMIT $inicio,12") or
                    ...
                    while ($reg = mysqli_fetch_array($registros)) {
                      ...
                      if ($inicio == 0)
                        ...
                        $anterior = $inicio - 12;
                        echo "<a href=\"tienda.php?pos=$anterior\">Anteriores </a>";
                      }
                      if ($impresos == 12) {
                        $proximo = $inicio + 12;
                        echo "<a href=\"tienda.php?pos=$proximo\"> Siguientes</a>";
                      } else
                        echo "Siguientes";
